...
class pseport_configuration(test.test):
    ...
    def run_once(self, test_path='', rasp_ip=None, user=None, relay_num=None, on_off=None):
        ...
        """
        logging.info('TEST CASE XX - AP Test - Manufacturing - PSE Port configuration Test')   
        ...
        port_speed = subprocess.check_output('/home/oc/host/ocmw/occmd get status ethernet.port2.speed', shell=True) 
        time.sleep(5)
        ...
        logging.info('COLLECTING MSATA Configuration ....')
        port_link = subprocess.check_output('/home/oc/host/ocmw/occmd get status ethernet.port2.link', shell=True)
        time.sleep(5)
        ...
        logging.info('COLLECTING MSATA Configuration ....')
        port_duplex = subprocess.check_output('/home/oc/host/ocmw/occmd get status ethernet.port2.duplex', shell=True)
        time.sleep(5)
